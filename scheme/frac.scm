...
;;; The iter adds new points to the data list using the positioning function.
;;; In short, fractal generates curves by repeating iter for n times.
;;; The positioning function proc takes two points as arguments and
;;; returns a list of the first point and the interpolated point.
